...
{
// DEBUT DE CLASSE UPLOAD abciweb.net version 3.1 compatible php >= 5.2
...
public function Set_Redim ($largeur_max = null, $hauteur_max = null, $rep = null, $qualite = null, $agrandissement = false)
{
	...
	$suffixe = $is_array_rep && isset($rep[0]) && $rep[0] != '' && $this->Verif_caracteres_fichier (trim($rep[0]),'suffixe') ? trim($rep[0]) : null;
	$this->redimension[$rep_redim][$i]['suffixe'] = $suffixe;

	$prefixe = $is_array_rep && !empty($rep[2]) && $rep[2] != '' && $this->Verif_caracteres_fichier (trim($rep[2]),'préfixe') ? trim($rep[2]) : null;
